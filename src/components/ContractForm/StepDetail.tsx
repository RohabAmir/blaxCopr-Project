...
const StepDetail: FC<any> = ({ handleStepChange }) => {
  ...
  return (
    <Flex vertical gap={40} style={{ width: "560px" }}>
      ...
      {new Array(itemsCount).fill('').map((_, i) => (<FormSection key={i} title="Transaction Details">
      ...
      <FormSection>
        <Row className="w-full">
          <Button name="Add new item " onClickHandler={() => setItemsCount(itemsCount + 1)} />
        </Row>
      </FormSection>
      {isShipping && <FormSection title="Shipping " buttonTitle="Remove" buttonClickHandler={() => setShipping(false)}>
        <Row style={{ width: "100%" }} justify={"space-between"}>
          <Col span={11}>
            <TextInput
              name="itemName"
        ...
        <Row style={{ width: "100%" }} justify={"space-between"}>
          <Col span={11}>
            <Dropdown
              ...
              options={[{ value: "seller", name: "seller" }, { value: "buyer", name: "buyer" }]}
            />
          </Col>
          <Col span={11}>
            <Dropdown
          ...
          <div className={styles.summary}>
            ...
            <div className={styles.flexDetailsLine}>
              <Flex align="center" className="w-full">
                ...
                <span className="w-full" style={{maxWidth:"100px",padding:"0px"}}>
                  <Dropdown
                    name="escrow-payee"
                    options={[
      ...
      <Flex className="w-full" align="flex-end" vertical>
