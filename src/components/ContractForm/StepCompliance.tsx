...
const StepCompliance: FC<IStepCompliance> = ({ }) => {
    ...
    return (
        <Flex vertical align='center' gap={20} style={{ width: '760px', margin: "auto" }}>
            <Flex align='center' justify='space-between' style={{ width: '100%', margin: 'auto' }}>
            ...
            <Flex vertical align='center' style={{ width: '400px', margin: 'auto' }}>
                <Flex vertical align='center' justify='center' gap={30} {...getRootProps()} className={styles.dragDropContainer}>
                    <DownloadOutlined />
                    <Text strong>Upload Documents.</Text>
                    <Text style={{ width: '50%', textAlign: 'center' }} >Drag and drop a file less than 5 MB.
                        Attach any supporting documents
                        related to the agreement</Text>
                ...
                <Flex>
                    ...
                    <Text>All your data is secured with encryption both during transmission and while stored, utilizing 256-bit AES and SSL/TLS encryption technologies.</Text>
                </Flex>
            </Flex>
        </Flex>
    )
