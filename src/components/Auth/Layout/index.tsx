    ...
    return (
        <Row justify="center" align="top" style={{ height: '100vh' }}>
            <Col span={12} style={{ height: "100%" }}>
                <Image src={HERO_IMAGE} alt="hero img" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
            </Col>
            <Col span={12} style={{ height: "100%", padding: "50px 75px", boxSizing: 'border-box' }}>
                <Flex justify='space-between' align='center'>
                    <Image src={BLAXCORP_LOGO} alt='blaxcorp logo' />
                    <Image src={CROSS_ICON} alt='cross' />
                </Flex>
                <Flex style={{ height: "80%", width: '400px', margin: 'auto' }} vertical align='center' justify='center' >
                    ...
                    <Flex vertical align='center' justify='center' gap={30}>
                        ...
                        <Flex align='center' justify='center' gap="large">
                            <span style={logoOutline}><Image src={GoogleLogo} alt="google logo" /></span>
                            <span style={logoOutline}><Image src={FacebookLogo} alt="facebook logo" /></span>
                            <span style={logoOutline}><Image src={AppleLogo} alt="apple logo" /></span>
                        </Flex>
